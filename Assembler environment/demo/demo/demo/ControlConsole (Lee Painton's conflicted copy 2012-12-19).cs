...
namespace demo
{
    public class ControlConsole : IPage
    {
        ...
        public ControlConsole(ContentManager Content)
        {
            ...
            temp = new CriticalStat("Temp", 60, -0.001F, new Vector2(185, 246), Content.Load<SpriteFont>("MS Quartz"));
            ...
            term = new Terminal(Content.Load<SpriteFont>("TerminalFont"), Content.Load<Texture2D>("CompCons"), Content.Load<Texture2D>("Darkness"), ">>");
        ...
        public void Draw(SpriteBatch sb)
        {
            ...
            sb.Draw(overlay, new Rectangle(0, 0, 800, 600), Color.Red*((temp.Value-60)/140F));
        }
